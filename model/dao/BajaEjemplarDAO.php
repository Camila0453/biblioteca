...
final class BajaEjemplarDAO extends DAO implements InterfaceDAO{
    ...
    public function save($baja):void{
        ...
        $sql = "INSERT INTO bajaejemplar VALUES( DEFAULT,:ejemplar,NOW(),:motivo,:idUsuario)";
        $stm = $this->conn->prepare($sql);
        $stm->execute(array(
            "motivo" => $baja->getMotivo(),
            "ejemplar" => $baja->getIdEjemplar(),
