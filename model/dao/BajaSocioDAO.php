...
final class BajaSocioDAO extends DAO implements InterfaceDAO{
    public function __construct($conn){
        parent::__construct($conn);
    }
    public function load($id): BajaSocioDAO{
    
    $baja= new BajaSocioDAO($id,);
    ...
    public function save($baja):void{
        ...
        $sql = "INSERT INTO bajassocios VALUES( DEFAULT,NOW(),:motivo, :usuario,:socioB)";
        $stm = $this->conn->prepare($sql);
        $stm->execute(array(
            "motivo" => $baja->getMotivo(),
            "usuario"=> $baja->getIdUsuario(),
            "socioB" => $baja->getIdSocio(),
