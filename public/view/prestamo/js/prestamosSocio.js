...
function list(){
    let estado="Inactivo";
     ...
     let cont=1;
           fetch("../usuario/pres",{"method":"POST", "headers":{"Content-Type":"application/json"}, "body": JSON.stringify({})
              ...
              prestamos.forEach((pres)=>{
               ...
               if(pres.estado==0){
                ...
                if(pres.tipo==0){
                   ...
                   html += '<td id=""><a href="ejemplaresPrestamoSocio/'+pres.idPres+'">Ver ejemplares </a></td>';
