...
<?php
   ...
   <script defer type="text/javascript" src="../../view/prestamo/js/ejemplaresPrestamoSocio.js"></script> 
...
<?php
    ...
    require_once "../model/dao/Conexion.php";
    $conexion = Conexion::establecer();
               $sql= "SELECT id,socio FROM prestamos WHERE id= '$data=trim($data,*)'";
   ...
   <!-- <p> bienvenido <?= $_SESSION["usuario"] ?></p>-->
    <br>
   <a href="../misPrestamos">Volver a la página de inicio</a>
    <br>
