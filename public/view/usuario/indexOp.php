...
<body>
   ...
   <br>
   <button type="button" class="btn btn-primary ms-3" style= "width:150px; height: 50px;"  onclick="showLibros()"> Libros</button>
   <br>
   <br>
   <button type="button" class="btn btn-primary ms-3" style= "width:150px; height: 50px;" onclick="showEjemplares()">Ejemplares</button>
   
   <br>
   <br>
   <button type="button" class="btn btn-primary ms-3" style= "width:150px; height: 50px;" onclick="showPrestamos()"> Préstamos</button>
  
   <br>

   <br>
   <button type="button" class="btn btn-primary ms-3"style= "width:150px; height: 50px;" onclick="showReservas()"> Reservas</button>
   <br>
   <br>
    </center>
